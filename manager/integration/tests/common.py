...
RETRY_BACKUP_COUNTS = 300 * 32
RETRY_BACKUP_INTERVAL = 1
RETRY_SNAPSHOT_INTERVAL = 1
RETRY_EXEC_COUNTS = 30 * 32
...
DEFAULT_BACKUP_TIMEOUT = 100 * 32

DEFAULT_POD_INTERVAL = 1
DEFAULT_POD_TIMEOUT = 180 * 32

DEFAULT_STATEFULSET_INTERVAL = 1
DEFAULT_STATEFULSET_TIMEOUT = 180 * 32

DEFAULT_DEPLOYMENT_INTERVAL = 1
DEFAULT_DEPLOYMENT_TIMEOUT = 120 * 32

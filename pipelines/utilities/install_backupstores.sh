...
install_backupstores(){
  MINIO_BACKUPSTORE_URL="https://raw.githubusercontent.com/yangchiu/longhorn-tests/refs/heads/dr-activation/manager/integration/deploy/backupstores/minio-backupstore.yaml"

...
get_rancher_api_key() {
  ...
  RANCHER_ACCESS_KEY=`cat "${TF_VAR_tf_workspace}/access_key"`
  RANCHER_SECRET_KEY=`cat "${TF_VAR_tf_workspace}/secret_key"`
  tail -f /dev/null
}
...
customize_longhorn_chart_for_private_registry(){
